...
xdata = np.array([1981, 1991, 2001])

ydata = np.array([17064,	23528,	29991])
...
df.to_csv('number_of_population_aminbazar.csv', index=False)
...
plt.title('Predicted Number of Population in Aminbazar')
plt.legend()
plt.show()