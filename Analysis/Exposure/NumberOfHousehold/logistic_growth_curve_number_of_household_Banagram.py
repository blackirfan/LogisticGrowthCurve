...
xdata = np.array([1991, 2001,2011,2022])

ydata = np.array([3532,5046,	7742,	9241])
...
df.to_csv('number_of_household_Banagram.csv', index=False)
...
plt.title('Predicted Number of Household in Banagram')
plt.legend()
plt.show()